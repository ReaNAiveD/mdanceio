...
pub struct Project {
    ...
    // camera: Option<Rc<PerspectiveCamera>>,
...
impl Project {
    ...
    pub const VIEWPORT_PRIMARY_NAME: &'static str = "@nanoem/Viewport/Primary";
    pub const VIEWPORT_SECONDARY_NAME: &'static str = "@nanoem/Viewport/Secondary";
